...
var isDebug = require('../../config/global').debug;
...
Logger.prototype.initialize = function (opts) {
    ...
    this.dProfile('component:Logger:initialize');
    ...
    this.dailyRotatePattern = opts.dailyRotatePattern;
    this.transports = opts.transports || [];
    this.wfTransports = opts.wfTransports || [];

    this.pathPrefix = this.dir + '/' + this.appname;

    this.create();

    this.info('Component Logger initialize DONE');
    this.dProfile('component:Logger:initialize');
};
...
Logger.prototype.create = function () {
    ...
    var dailyRotatePattern = this.dailyRotatePattern;
...
Logger.prototype.log = function (level, args, logger) {
    ...
    var prefix = ''
        + process.pid
        + ' ['
        + path.relative(this.appdir, info.currentFile)
        + ':'
        + info.currentLine
        + '] ';
